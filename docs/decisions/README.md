...
Each ADR records one decision, its context, consequences, and — importantly — a
**revisit trigger** so a decision made under today's assumptions is reopened when those
assumptions change.
